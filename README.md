...
- [docs/windows.md](docs/windows.md) - Windows setup through Git Bash, Herdr runtime selection, and known limits.
...
- [docs/windows.md](docs/windows.md) - native Windows setup and backend limits through Git Bash.
